...
### Add line here converting the weights file to sha256 and renaming the file with the hash
#cp -r /object-detection/0128cdfa3963288110422e4c1a57afe76aa0d760eb706cda4353ef1432c31b9c/ ~
